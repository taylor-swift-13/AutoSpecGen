...
/*@ 
  ...
  ensures !((pIp->mThrDistribute.stateFlag[0] == 1 && pIp->mThrDistribute.stateFlag[1] == 1) || (pIp->mThrDistribute.stateFlag[0] == 0 && pIp->mThrDistribute.stateFlag[1] == 1)) ==> pIp->mThrDistribute.flgABChoose == TBS_A;
*/
