...
/*@ 
  ...
  assigns pIp->pGyroData->JoinTotal, pIp->flgGryoCalc, 
          pIp->pGyroData->Rtemp[0..2][0..4], 
          pIp->pGyroData->gyroStatus1;
  ensures pIp->pGyroData->JoinTotal == \old(MIN(pIp->pGyroData->JoinTotal, 5));
*/
