...
/*@ 
  ...
  assigns pIp->flg160INT, pIp->flgPRSAM, pIp->mGyroData, 
          pIp->countSate, pIp->countPublic, pIp->countMode, 
          pIp->countInt32ms, pIp->mFWarning, pIp->mThrDistribute, 
          pIp->mModulator, pIp->flgGryoCalc;
*/
