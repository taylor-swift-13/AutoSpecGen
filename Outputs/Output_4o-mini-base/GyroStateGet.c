...
/*@ requires pIp != \null;
    ...
    ensures \forall integer i; 0 <= i < pIp->NumGyro ==> 
        pIp->wa[i] == DiviationToFloat((gyroRecvData[2 + i*2] << 8) | (gyroRecvData[2 + i*2 + 1])) &&
