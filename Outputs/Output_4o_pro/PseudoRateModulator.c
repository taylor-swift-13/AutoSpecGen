...
/*@ 
  ...
  requires \separated(pIp->pModulator, pIp->pModulator);
  ...
  ensures (-pIp->h1 <= pIp->pModulator->u - pIp->pModulator->r <= pIp->h1) ==> (pIp->pModulator->Yp == 0x0 && pIp->pModulator->Yn == 0x0 && pIp->pModulator->r == \old(0.9231f * pIp->pModulator->r));
