...
/*@ 
  ...
  ensures pIp->pModulator->Yp == (pIp->pModulator->u - pIp->pModulator->r > pIp->h1 ? 0x0 :
                                  (pIp->pModulator->u - pIp->pModulator->r < -pIp->h1 ? 0xF : 0x0));
  ensures pIp->pModulator->Yn == (pIp->pModulator->u - pIp->pModulator->r < -pIp->h1 ? 0x0 : 
                                  (pIp->pModulator->u - pIp->pModulator->r > pIp->h1 ? 0xF : 0x0));
