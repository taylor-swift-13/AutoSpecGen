...
/*@ 
  ...
  ensures pIp->mModulator[0].u <= 1.3f && pIp->mModulator[0].u >= -1.3f;
  ensures pIp->mModulator[1].u <= 1.3f && pIp->mModulator[1].u >= -1.3f;
  ensures pIp->mModulator[2].u <= 1.3f && pIp->mModulator[2].u >= -1.3f;
*/
