...
requires \valid(pIp->VG[0] + (0..2));
requires \valid(pIp->VG[1] + (0..2));
requires \valid(pIp->VG[2] + (0..2));
requires \valid(pIp->VG[3] + (0..2));
requires \valid(pIp->VG[4] + (0..2));
...
assigns pIp->pGyroData->JoinTotal, pIp->flgGryoCalc, pIp->pGyroData->gyroStatus1, Rgtrans[0..2][0..4], Rs[0..2][0..2], RsInv[0..2][0..2], Rgtemp[0..4][0..2], pIp->pGyroData->Rtemp[0..2][0..4];
*/
