...
/*@ 
  ...
  ensures pIp->countPublic == 0 || pIp->countPublic <= 16;
  assigns pIp->countPublic, pIp->flgMode, pIp->countMode, pIp->pCtrl[0].Up, pIp->pCtrl[1].Up, pIp->pCtrl[2].Up, pIp->mFWarning.flgups, pIp->mFWarning.countUPSpc, pIp->flgPRSAM;
*/
