...
/*@ 
  ...
  ensures -1.3f <= pIp->mModulator[0].u && pIp->mModulator[0].u <= 1.3f;
  ensures -1.3f <= pIp->mModulator[1].u && pIp->mModulator[1].u <= 1.3f;
  ensures -1.3f <= pIp->mModulator[2].u && pIp->mModulator[2].u <= 1.3f;
*/
void ThreeAxisControllerFun(ThreeAxisController *pIp)
{
    /*@ assert \valid(pIp); */
    /*@ assert \valid(pIp->mController + (0 .. 2)); */
    /*@ assert \valid(pIp->mModulator + (0 .. 2)); */
    /*@ assert \valid(pIp->CTRL_PARAM_SAM + (0 .. 2)); */
