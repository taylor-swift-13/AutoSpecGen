...
/*@ 
  requires \valid(pIp);
  ensures pIp->mFWarning.countSPset == \old(pIp->mFWarning.countSPset) + 1 || pIp->mFWarning.countSPset == 0;
  ensures \old(pIp->mFWarning.countSPset) != 10 ==> pIp->mFWarning.countSPset == \old(pIp->mFWarning.countSPset) + 1;
  ensures \old(pIp->mFWarning.countSPset) == 10 ==> pIp->mFWarning.countSPset == 0;
